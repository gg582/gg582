...
인턴십의 일환으로 레거시 Java 환경(OpenJDK 8)과 문서 OCR DB 분석을 다루었으며, 동시에 커널 레벨 최적화와 인프라 설계에도 꾸준히 관심을 두고 있습니다.

*메타빌드 3개월 인턴십 수행(3월 3일 - 6월 2일)*
...
* 엑셀에 포함된 Visual Basic 코드를 Golang+Javascript(Next.js)로 리팩토링
  * 지급된 Claude Code를 사용하였으나 서버 최적화 로직이 들어감
* 강점: Go와 파이썬 기반으로 경량 웹 서버로 변모
* 단점: 오로지 학습용 앱임.
...
* 텔넷 2323, SSH 22 포트
* [웹터미널(내려갈수있음)](https://retro-chatroom.kakashit.org/)
...
* 최석정의 지수귀문도 문제에서 영감을 받은 셔플을 포함하는 AES-256 변형
...
* 한계: 암묵적인 코드 라인 존재, WebTransport는 서버만 지원
...
![Grade](https://github-readme-stats-rouge-rho-81.vercel.app/api?username=gg582&show_icons=true)
![Total Lines of Code](https://github.com/gg582/allcloc/blob/main/public/banner.svg)
![백준 서비스 종료 전 골드 II 캡처](https://github.com/gg582/gg582/blob/main/%EB%B0%B1%EC%A4%80%EA%B8%B0%EB%A1%9D%EC%84%B1%EC%BA%A1%EC%B3%902026.png?raw=true)
